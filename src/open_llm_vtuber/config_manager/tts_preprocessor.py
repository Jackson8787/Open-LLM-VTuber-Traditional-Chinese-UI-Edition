...
class DeepLXConfig(I18nMixin):
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "deeplx_api_endpoint": Description(
            en="API endpoint URL for DeepLX service", zh="DeepLX 服務的 API 端點 URL"
        ),
    }
...
class TencentConfig(I18nMixin):
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        "secret_id": Description(en="Tencent Secret ID", zh="騰訊服務的 Secret ID"),
        "secret_key": Description(en="Tencent Secret Key", zh="騰訊服務的 Secret Key"),
        "region": Description(en="Region for Tencent Service", zh="騰訊服務使用的區域"),
        "source_lang": Description(
            en="Source language code for tencent translation", zh="騰訊翻譯的來源語言代碼"
        ),
...
class TranslatorConfig(I18nMixin):
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        "translate_audio": Description(
            ...
            zh="啟用音訊翻譯（需要部署 DeepLX）",
        ),
        "translate_provider": Description(
            en="Translation service provider to use", zh="要使用的翻譯服務提供者"
        ),
        "deeplx": Description(
            en="Configuration for DeepLX translation service", zh="DeepLX 翻譯服務設定"
        ),
        "tencent": Description(
            en="Configuration for TenCent translation service", zh="騰訊翻譯服務設定"
        ),
    }
...
class TTSPreprocessorConfig(I18nMixin):
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "translator_config": Description(
            en="Configuration for translation services", zh="翻譯服務設定"
        ),
    }
